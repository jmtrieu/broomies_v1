...
class HomeDoneDataSource: NSObject, UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell:HomeCellView! = (tableView.dequeueReusableCell(withIdentifier: "DoneCellView") as! HomeCellView)
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        nc.post(name: Notification.Name(rawValue: "done"), object: nil, userInfo: ["ip" : indexPath])
    }
